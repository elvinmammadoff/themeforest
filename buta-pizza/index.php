...
<div class="body-wrapper">
    ...
    <div class="container section" id="about_us">
        <div class="col-sm-12 d-flex flex-xs-column">
            <div class="col-sm-6 d-flex align-items-center padd_lr0" data-aos="fade-left">
                <div class="content">
            ...
            <div class="col-sm-6 img text-center padd_lr0" data-aos="fade-right">
                <div class="border_on">
                    <img src="http://via.placeholder.com/581x455" alt="sample" class="about_img" />
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="reserv_box">
                        ...
                        <form id="reserv_form" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form_pos">
                                        <input type="text" name="name" placeholder="Your name" class="form-control" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your name'" />
                                        <span class="form_icon"></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form_pos">
                                        <input type="email" name="email" placeholder="Your email" class="form-control" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your email'" />
                                        <span class="form_icon"></span>
                                    </div>
                                </div>    
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form_pos">
                                        <input type="text" name="date" placeholder="Date" class="form-control" id="reserv_date" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Date'" />
                                        <span class="form_icon"></span>
                                    </div>
                                </div>
                                <div class="col-md-4"> 
                                    <div class="form-group form_pos">
                                        <input type="text" name="time" placeholder="Time" class="form-control" id="reserv_time" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Time'"  />
                                        <span class="form_icon"></span>
                                    </div>
                                </div>    
                            </div>
        ...
        <div id="photo_gallery">
            <div class="row">
                <div class="col-md-3">
                    <a href="javascript:;" class="block">
                        <div class="content">
                            <img src="http://via.placeholder.com/300x300" alt="sample" />
                            <div class="zoom">
                ...
                <div class="copyright">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="copy_text">
                                    Copyright © 2017 Agency <span>|</span> All Rights Reserved
                                </div>
                            </div>
                            <div class="col-md-4">
